...
try:
    # Third-Party
    from cpex_encoded_exfil_detection.encoded_exfil_detection_rust import ExfilDetectorEngine as _RustEngine  # pragma: no cover
    from cpex_encoded_exfil_detection.encoded_exfil_detection_rust import py_scan_container as encoded_exfil_detection  # noqa: F401 — backward compat  # pragma: no cover
